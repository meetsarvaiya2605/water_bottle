"""
Django settings for bottle_pro project.
...
SECRET_KEY = 'django-insecure-v=mp*a2@=hv#xeqzy4)*^ccrq26o(q*&_n_g8rkhpy-s+0==&j'
...
WSGI_APPLICATION = 'bottle_pro.wsgi.application'
